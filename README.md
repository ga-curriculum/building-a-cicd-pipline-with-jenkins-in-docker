...
🟢 [Jenkins + Docker Starter code](https://git.generalassemb.ly/modular-curriculum-all-courses/building-a-cicd-pipline-with-jenkins-in-docker-starter): Sets up your CI/CD environment.
